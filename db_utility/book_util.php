...
function addBookToDB($isbn,$title,$author,$publisher,$publisher_year,$short_description,$genre, $cover = null){
    $result = 0;
    $link = createMySQLConnection();
...
function updateBooktoDB($title,$author,$publisher,$publisher_year,$short_description,$genre, $cover){
    $result = 0;
    $link = createMySQLConnection();
    $link->beginTransaction();
